...
## Switzerland
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(switzerland.confirmed, switzerland.deaths, switzerland.recovered, "Switzerland", 55, NA, trend.angle = 5)
```

## Italy
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(italy.confirmed, italy.deaths, italy.recovered, "Italy", NA, 3)
```
...
## Germany
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(germany.confirmed, switzerland.deaths, germany.recovered, "Germany", 48, NA, trend.angle = 10)
```
...
## Great Britain
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(uk.confirmed, uk.deaths, uk.recovered, "Great Britain", NA, NA, trend.angle = 30)
```
...
plot_time_series_for_country(usa.confirmed, usa.deaths, NA, "USA", NA, NA, trend.angle=30)
```
