...
country.names <- c("Switzerland", "Italy", "France", "Germany", "Austria" , "Spain", "Great Britain", "Iceland")
...
yrange <- c(0, max.y)
plot(xrange, yrange, main= "New Confirmed Cases per Day", type = "n", xlab = "Days Since 2020-01-21", ylab = "Number of New Cases per Day")
for (i in seq(1, country.count)) {
  lines(seq(2, day.count) - 0.4 + 0.115 * i, diff(countries.confirmed[[i]]), type = "h", col = col[i], lty = 1, lw = 2)
}
grid()
legend("topleft", legend = country.names, col = col, lty = 1, lw = 4, title = "Country")
```
...
xrange <- c(50, day.count)
yrange <- c(0, max.y)
plot(xrange, yrange, main= "New Deaths per Day", type = "n", xlab = "Days Since 2020-01-21", ylab = "Number of New Deaths per Day")
for (i in seq(1, country.count)) {
  lines(seq(2, day.count) - 0.4 + 0.115 * i, diff(countries.deaths[[i]]), type = "h", col = col[i], lty = 1, lw = 2)
}
grid()
legend("topleft", legend = country.names, col = col, lty = 1, lw = 4, title = "Country")
```
...
yrange <- c(0, max.y)
plot(xrange, yrange, main= "New Recovered Cases per Day", type = "n", xlab = "Days Since 2020-01-21", ylab = "Number of New Recovered Cases per Day")
for (i in seq(1, country.count)) {
  lines(seq(2, day.count) - 0.4 + 0.115 * i, diff(countries.recovered[[i]]), type = "h", col = col[i], lty = 1, lw = 2)
}
grid()
legend("topleft", legend = country.names, col = col, lty = 1, lw = 4, title = "Country")
```
...
plot(xrange, yrange, main= "New Active Cases per Day", type = "n", xlab = "Days Since 2020-01-21", ylab = "Number of New Active Cases per Day")
for (i in seq(1, country.count)) {
  y <- countries.confirmed[[i]] - (countries.recovered[[i]] + countries.deaths[[i]])
  lines(seq(2, day.count) - 0.4 + 0.115 * i, diff(y), type = "h", col = col[i], lty = 1, lw = 2)
}
grid()
legend("topleft", legend = country.names, col = col, lty = 1, lw = 4, title = "Country")
```
