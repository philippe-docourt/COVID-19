...
plot_time_series_for_country <- function(country.confirmed, country.deaths, country.recovered, country.name, public.spaces.closed.at=NA, confinement.at=NA) {
  ...
  plot(country.confirmed, main= paste("Cases in", country.name), type = "o", xlab = "Days Since January 21, 2020", ylab = "Number of Cases", col = "red", xlim =  c(day.start, day.count + 5), ylim = ylim)
  ...
  text(x = day.count + 1.5, y = 0.65 * ylim[2], paste(dy, "cases/day\nExtrapolation:", dy * 7, "case/week\n", last.progression.pct, "% progress last day"), srt = 60, col = "violet")
  ...
  last.progression.pct <- round((100 * dy) / last.confirmed[1])
  text(x = day.count - 4.5, y = 0.7 * ylim[2], paste(dy, "cases/week\nAvg:", dy %/% 7, "case/day\n", last.progression.pct, "% progress last week"), srt = 60, col = "black")
