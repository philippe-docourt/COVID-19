...
## Switzerland
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(switzerland.confirmed, switzerland.deaths, switzerland.recovered, "Switzerland", 55, NA, trend.angle = 10)
```
...
## Norway
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(norway.confirmed, norway.deaths, norway.recovered, "Norway", NA, NA, trend.angle = 3)
```
...
## Iceland
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(iceland.confirmed, iceland.deaths, iceland.recovered, "Iceland", NA, NA, trend.angle = 3)
```
...
plot_time_series_for_country(usa.confirmed, usa.deaths, NA, "USA", NA, NA, trend.angle=35)
```
