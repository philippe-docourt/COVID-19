...
plot_time_series_for_country <- function(country.confirmed, country.deaths, country.recovered, country.name, public.spaces.closed.at=NA, confinement.at=NA, trend.angle=20) {
  ...
  last.progression.pct <- round((100 * dy) / last.confirmed[1])
  text(x = day.count - 8, y = (0.88 - (trend.angle/3000)) * ylim[2], paste(dy, "cases/week\nAvg:", dy %/% 7, "case/day\n", last.progression.pct, "% progress last week"), srt = trend.angle, col = "black")
  ...
  if (!is.na(public.spaces.closed.at)) {
    ...
    text(x = public.spaces.closed.at - 1, y = ypos, "All public spaces are closed", col = "blue", srt = 90)
  }
...
## Switzerland
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(switzerland.confirmed, switzerland.deaths, switzerland.recovered, "Switzerland", 55, NA, trend.angle = 15)
```
...
## France
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(france.confirmed, germany.deaths, france.recovered, "France", 53, 56, trend.angle = 10)
```

## Germany
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(germany.confirmed, switzerland.deaths, germany.recovered, "Germany", 48, NA, trend.angle = 15)
```

## Austria
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(austria.confirmed, austria.deaths, austria.recovered, "Austria", 52, NA, trend.angle = 8)
```

## Spain
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(spain.confirmed, spain.deaths, spain.recovered, "Spain", NA, 53, trend.angle = 15)
```

## Great Britain
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(uk.confirmed, uk.deaths, uk.recovered, "Great Britain", NA, NA, trend.angle = 40)
```

## Denmark
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(denmark.confirmed, denmark.deaths, denmark.recovered, "Denmark", NA, NA, trend.angle = 20)
```

## Norway
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(norway.confirmed, norway.deaths, norway.recovered, "Norway", NA, NA, trend.angle = 5)
```

## Sweden
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(sweden.confirmed, sweden.deaths, sweden.recovered, "Sweden", NA, NA, trend.angle = 40)
```

## Iceland
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(iceland.confirmed, iceland.deaths, iceland.recovered, "Iceland", NA, NA, trend.angle = 5)
```
...
plot_time_series_for_country(hubei.confirmed, hubei.deaths, hubei.recovered, "Hubei Province, China", NA, 2, trend.angle = 0)
```
...
plot_time_series_for_country(usa.confirmed, usa.deaths, NA, "USA", NA, NA, trend.angle=40)
```
...
grid()
legend("topleft", legend = country.names, col = col, lty = 1, lw = 4, title = "Country", ncol = 4)
```
