...
plot_time_sery_for_country(italy.confirmed, italy.deaths, italy.recovered, "Italy", NA, NA, 49)
plot_time_sery_for_country(france.confirmed, germany.deaths, france.recovered, "France", NA, 53, 56)
...
plot_time_sery_for_country(spain.confirmed, spain.deaths, spain.recovered, "Spain", NA, NA, 53)
plot_time_sery_for_country(uk.confirmed, uk.deaths, uk.recovered, "Great Britain", NA, NA, NA)
plot_time_sery_for_country(iceland.confirmed, iceland.deaths, iceland.recovered, "Iceland", NA, NA, NA)
plot_time_sery_for_country(hubei.confirmed, hubei.deaths, hubei.recovered, "Hubei Province, China", NA, NA, 2)
```
...
See https://github.com/CSSEGISandData/COVID-19/blob/master/README.md for more details.
...
* Source code for generating graphs: Copyright Philippe Docourt. Licensed under MIT License.
