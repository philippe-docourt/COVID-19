...
## Switzerland
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(switzerland.confirmed, switzerland.deaths, switzerland.recovered, "Switzerland", 55, NA, trend.angle = 55)
```

## Italy
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(italy.confirmed, italy.deaths, italy.recovered, "Italy", NA, trend.angle = 55)
```

## France
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(france.confirmed, germany.deaths, france.recovered, "France", 53, 56, trend.angle = 65)
```

## Germany
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(germany.confirmed, switzerland.deaths, germany.recovered, "Germany", 48, NA, trend.angle = 45)
```

## Austria
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(austria.confirmed, austria.deaths, austria.recovered, "Austria", 52, NA, trend.angle = 60)
```

## Spain
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(spain.confirmed, spain.deaths, spain.recovered, "Spain", NA, 53, trend.angle = 50)
```

## Great Britain
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(uk.confirmed, uk.deaths, uk.recovered, "Great Britain", NA, NA, trend.angle = 65)
```

## Denmark
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(denmark.confirmed, denmark.deaths, denmark.recovered, "Denmark", NA, NA, trend.angle = 50)
```

## Norway
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(norway.confirmed, norway.deaths, norway.recovered, "Norway", NA, NA, trend.angle = 65)
```

## Sweden
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(sweden.confirmed, sweden.deaths, sweden.recovered, "Sweden", NA, NA, trend.angle = 30)
```

## Iceland
```{r, echo=FALSE, warning=FALSE}
plot_time_series_for_country(iceland.confirmed, iceland.deaths, iceland.recovered, "Iceland", NA, NA, trend.angle = 0)
```
...
plot_time_series_for_country(usa.confirmed, usa.deaths, NA, "USA", NA, NA, trend.angle=25)
```
